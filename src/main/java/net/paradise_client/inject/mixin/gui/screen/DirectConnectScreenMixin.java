...
@Mixin(DirectJoinServerScreen.class) public abstract class DirectConnectScreenMixin extends Screen {
  ...
  private void drawInfo(GuiGraphicsExtractor graphics, String label, String value, int x, int y) {
